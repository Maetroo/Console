...
public class RemoveLower extends AbstractCommand {
    ...
    public void execute(String[] args, Collection collection) throws InvalidArgumentException {
        ...
        if (!Script.empty && !success) {
            ...
            else if (size == collection.getLaboratories().size())
                System.out.println("Could not find element less than entered!");
            
            else
                System.out.println("Successfully removed all elements less than entered.");
        }
